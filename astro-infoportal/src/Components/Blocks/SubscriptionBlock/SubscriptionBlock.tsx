  ...
  return (
    <div className="col-sm-12 col-md-10 col-lg-8 offset-md-1 offset-lg-2 pb-3">
      <div className="a-card a-cardImage mt-4">
        <img
          src="/Static/img/illustration/illustrasjon_nyhetsbrev.svg"
          alt=""
        />
        <div className="a-cardImage-text">
          ...
          >
            ...
            <div className="row">
              <div className="col-8">
                <div className="form-group a-form-group">
                  <label className="a-form-label sr-only" htmlFor="text-input-epost">
                    {emailLabel || ""}:{" "}
                  </label>

                  <div className="a-form-group-items input-group">
                    <span className="input-group-prepend d-none d-md-block">
                      <i className="ai ai-closedmessage" aria-hidden="true" />
                    </span>
            ...
            <p className="a-fontSizeXS a-js-finishText" style={{ display: "none" }}>
              {confirmationText || ""}{" "}
              <a className="a-js-undo">{undoText || ""}</a>
            </p>
            <p className="a-fontSizeXS a-js-altText" style={{ display: "none" }}>
              {confirmationUndoText || ""}
            </p>
          </form>
        </div>
